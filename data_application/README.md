...
- `PM_mortality.R` contains the code to load the data, preprocess the data, estimate the truncated exposure effects using five methods, and create plots of the estimates.
