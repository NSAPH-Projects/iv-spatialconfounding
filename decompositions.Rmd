...
png("images/corspectraldgm1.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[3]]$nestedmat, 
                  D=D,
                  spectralmat = out[[3]]$spectralmat,
                     ylab='Cor(X,Z)',
                     hline=0,
                     ylim=c(-1.1,1.1),
                     col='purple', 
...
plotfunc(nestedmat = out[[6]]$nestedmat, spectralmat = out[[6]]$spectralmat, 
          D=D,
         mains = c('Nested: Estimation', 'Spectral: Ground Truth'))
dev.off()
```
...
plotfunc(nestedmat = out[[7]]$nestedmat, spectralmat = out[[7]]$spectralmat, 
         D=D,
         mains = c('Nested: Ground Truth', 'Spectral: Estimation'))
dev.off()
```
...
plotfunc(
  nestedmat = out[[9]]$nestedmat,
  spectralmat = out[[9]]$spectralmat,
  D=D,
  ylim = c(-4, 4),
  mains = c('Nested: Ground Truth', 'Spectral: Estimation')
)
...
plotfunc(
  nestedmat = out[[11]]$nestedmats[, , 1],
  spectralmat = out[[11]]$spectralmats[, , 1],
  D=D,
  ylim = c(-2, 2),
...
plotfunc(
  nestedmat = out[[11]]$nestedmats[, , 2],
  spectralmat = out[[11]]$spectralmats[, , 2],
  D=D,
  ylim = c(-2, 2),
  hline = 1,
...
plotfunc(
  nestedmat = out[[12]]$nestedmats[, , 1],
  spectralmat = out[[12]]$spectralmats[, , 1],
  D=D,
  ylim = c(-2, 2),
...
plotfunc(
  nestedmat = out[[12]]$nestedmats[, , 2],
  spectralmat = out[[12]]$spectralmats[, , 2],
  D=D,
  hline = 1,
  ylim = c(-2, 2),
...
# Simulations: US graph, real covariate

```{r, sim13, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realcornesteddgm.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[13]]$nestedmat, 
                     spectralmat = out[[13]]$spectralmat,
                      D=D,
                     ylab='Cor(X,Z)',
                     hline=0,
                     ylim=c(-1,1),
...
png("images/realnesteddgm.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[14]]$nestedmat, spectralmat = out[[14]]$spectralmat, 
         D=D,
         mains = c('Nested: Ground Truth', 'Spectral: Estimation'))
dev.off()
```
...
png("images/realcorspectraldgm1.jpeg", height = 600, width = 1300, res = 200)
...
```{r, sim16, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realspectraldgm1.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[16]]$nestedmat, spectralmat = out[[16]]$spectralmat, 
         D=D,
         mains = c('Nested: Estimation', 'Spectral: Ground Truth'))
dev.off()
```

```{r, sim17, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realcorspectraldgm2.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[17]]$nestedmat, 
                       D=D,
...
```{r, sim18, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realspectraldgm2.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[18]]$nestedmat, spectralmat = out[[18]]$spectralmat, 
          D=D,
         mains = c('Nested: Estimation', 'Spectral: Ground Truth'))
dev.off()
```

```{r, sim19, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/reallocalnested.jpeg", height = 600, width = 1300, res = 200)
plotfunc(nestedmat = out[[19]]$nestedmat, spectralmat = out[[19]]$spectralmat, 
         D=D,
         mains = c('Nested: Ground Truth', 'Spectral: Estimation'))
dev.off()
```

```{r, sim20, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/reallocalspectral.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[20]]$nestedmat,
  spectralmat = out[[20]]$spectralmat,
  D=D,
  mains = c('Nested: Estimation', 'Spectral: Ground Truth')
)
dev.off()
...
png("images/realinteraction_nested.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[21]]$nestedmat,
  spectralmat = out[[21]]$spectralmat,
  D=D,
  ylim = c(-4, 4),
  mains = c('Nested: Ground Truth', 'Spectral: Estimation')
)
...
png("images/realinteraction_spectral.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[22]]$nestedmat,
  spectralmat = out[[22]]$spectralmat,
  D=D,
  ylim = c(-5, 5),
  mains = c('Nested: Estimation', 'Spectral: Ground Truth')
)
...
```{r, sim23, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realquadratic_nested.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[23]]$nestedmats[, , 1],
  spectralmat = out[[23]]$spectralmats[, , 1],
  D=D,
  ylim = c(-2, 2),
  mains = c('Nested Linear: Ground Truth', 'Spectral Linear: Estimation')
)
...
png("images/realquadratic_nested2.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[23]]$nestedmats[, , 2],
  spectralmat = out[[23]]$spectralmats[, , 2],
  D=D,
  ylim = c(-2, 2),
  hline = 1,
  mains = c('Nested Quadratic: Ground Truth', 'Spectral Quadratic: Estimation')
...
```{r, sim24, cache = T, echo = F, message = F, results = 'hide', warning = F}
png("images/realquadratic_spectral.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[24]]$nestedmats[, , 1],
  spectralmat = out[[24]]$spectralmats[, , 1],
  D=D,
  ylim = c(-2, 2),
  mains = c('Nested Linear: Estimation', 'Spectral Linear: Ground Truth')
)
...
png("images/realquadratic_spectral2.jpeg", height = 600, width = 1300, res = 200)
plotfunc(
  nestedmat = out[[24]]$nestedmats[, , 2],
  spectralmat = out[[24]]$spectralmats[, , 2],
  D=D,
  hline = 1,
  ylim = c(-2, 2),
  mains = c('Nested Quadratic: Estimation', 'Spectral Quadratic: Ground Truth')
