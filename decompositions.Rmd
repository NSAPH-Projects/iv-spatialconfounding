...
png('images/spatial_Xstar.jpeg', width = 1000, height = 1000, res = 150)
par(mfrow = c(3,3))
...
png('images/spatial_Ystar.jpeg', width = 1000, height = 1000, res = 150)
par(mfrow = c(3,3))
for (i in 1:length(Bks)){
  window = (num*(i-1) + 1):(num*i)
  window = setdiff(window, zeroeig)
...
png('images/spatial_Zstar.jpeg', width = 1000, height = 1000, res = 150)
par(mfrow = c(3,3))
for (i in 1:length(Bks)){
  window = (num*(i-1) + 1):(num*i)
  window = setdiff(window, zeroeig)
