...
out = simfunc(rhox= seq(0,1, by = 1/(5^4-1)),dgm='spectral', nest=nest,spec=spec,specinv = specinv)
...
out = simfunc(rhox=rep(0,625), dgm='spectral', nest=nest, spec=spec, specinv = specinv)
plotfunc(nestedmat = out$nestedmat, spectralmat = out$spectralmat)
```
...
out = simfunc(rhox=rep(0, 5^4), dgm='spectral', nest=nest, spec=spec, specinv = specinv,
...
out = simfunc(rhox=seq(0,1, by = 1/(5^4-1)), dgm='spectral', nest=nest, 
              spec=spec, specinv=specinv, outcome = 'interaction', betaxz=0.5)
plotfunc(nestedmat = out$nestedmat, spectralmat = out$spectralmat, ylim = c(0.5, 4))
```
